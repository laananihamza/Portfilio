    ...
    <header ref={header} className={`px-10  flex items-center justify-between duration-100 w-full ${position ? '!py-3 duration-100 fixed bg-white' : 'relative bg-transparent py-5'} top-0`}>
      ...
      <div className="links">
        ...
        <div className="mobile-links block md:hidden">
          <FontAwesomeIcon icon={faBars} onClick={() => setOpenMenu(true)} size="lg" className="cursor-pointer" />
          <div className={`link-section p-5 min-h-screen w-[40%] fixed top-0 right-0 shadow-lg duration-300 bg-white z-50 ${openMenu ? 'right-0' : '-right-96'}`}>
          ...
          <li className={`relative before:absolute before:-bottom-2 before:left-0 before:bg-gradient-to-br before:from-blueHover before:to-violetHover ${activeSection === 'home' ? 'before:w-full' : 'before:w-0'} before:duration-200 hover:before:w-full before:h-0.5`}><a href="#home">Home</a></li>
          <li className={`relative before:absolute before:-bottom-2 before:left-0 before:bg-gradient-to-br before:from-blueHover before:to-violetHover ${activeSection === 'about' ? 'before:w-full' : 'before:w-0'} before:duration-200 hover:before:w-full before:h-0.5`}><a href="#about" >About</a></li>
          <li className={`relative before:absolute before:-bottom-2 before:left-0 before:bg-gradient-to-br before:from-blueHover before:to-violetHover ${activeSection === 'resume' ? 'before:w-full' : 'before:w-0'} before:duration-200 hover:before:w-full before:h-0.5`}><a href="#resume">Resume</a></li>
          <li className={`relative before:absolute before:-bottom-2 before:left-0 before:bg-gradient-to-br before:from-blueHover before:to-violetHover ${activeSection === 'skills' ? 'before:w-full' : 'before:w-0'} before:duration-200 hover:before:w-full before:h-0.5`}><a href="#skills" >Skills</a></li>
          <li className={`relative before:absolute before:-bottom-2 before:left-0 before:bg-gradient-to-br before:from-blueHover before:to-violetHover ${activeSection === 'portfolio' ? 'before:w-full' : 'before:w-0'} before:duration-200 hover:before:w-full before:h-0.5`}><a href="#portfolio">Portfolio</a></li>
          <li className={`relative before:absolute before:-bottom-2 before:left-0 before:bg-gradient-to-br before:from-blueHover before:to-violetHover ${activeSection === 'contact' ? 'before:w-full' : 'before:w-0'} before:duration-200 hover:before:w-full before:h-0.5`}><a href="#contact">Contact</a></li>
        </ul>
          </div>
        </div>
      </div>
